...
class AdminPageContentController extends Controller
{
    ...
    public function updateOurStory(Request $request): RedirectResponse
    {
        $validated = $request->validate([
            ...
            'stat_1_value' => ['required', 'integer', 'min:0', 'max:99999'],
            'stat_1_suffix' => ['nullable', 'string', 'max:10'],
            'stat_1_label' => ['required', 'string', 'max:120'],
            'stat_2_value' => ['required', 'integer', 'min:0', 'max:99999'],
            'stat_2_suffix' => ['nullable', 'string', 'max:10'],
            'stat_2_label' => ['required', 'string', 'max:120'],
            'stat_3_value' => ['required', 'integer', 'min:0', 'max:99999'],
            'stat_3_suffix' => ['nullable', 'string', 'max:10'],
        ...
        $contentToSave = [
            ...
            'stat_1_value' => (string) $validated['stat_1_value'],
            'stat_1_suffix' => $validated['stat_1_suffix'] ?? '',
            'stat_1_label' => $validated['stat_1_label'],
            'stat_2_value' => (string) $validated['stat_2_value'],
            'stat_2_suffix' => $validated['stat_2_suffix'] ?? '',
            'stat_2_label' => $validated['stat_2_label'],
            'stat_3_value' => (string) $validated['stat_3_value'],
            'stat_3_suffix' => $validated['stat_3_suffix'] ?? '',
